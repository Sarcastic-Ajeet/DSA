  ...
  <p> <h1> <b>916. Word Subsets</b></h1>  </p>
  <div class="flex gap-1"><div><div class="elfjS" data-track-load="description_content"><p>You are given two string arrays <code>words1</code> and <code>words2</code>.</p>
...
</div></div><div class="mt-8"><div class="text-label-2 dark:text-dark-label-2 text-xs">Copyright ©️ 2025 LeetCode All rights reserved</div></div></div>
